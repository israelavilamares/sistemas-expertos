...
(defrule rule-4
  ...
  (product (part-number ?smartphone-part-number) (category "smartphone"))
  
  
  ?funda <- (product (name "Funda para celular") (category "accesorio") (price ?precio-funda))
  ?mica <- (product (name "Mica") (category "accesorio") (price ?precio-mica))
