...
(deffacts computadoras
  (computadoras (part-number "dell-xps13-001") (marca "Dell") (modelo "XPS 13") (color "Plata") (price 25999) (procesador "Intel i7"))
  (computadoras (part-number "hp-spectre-001") (marca "HP") (modelo "Spectre x360") (color "Negro") (price 23999) (procesador "Intel i5"))
  (computadoras (part-number "macbook-air-001") (marca "Apple") (modelo "MacBook Air") (color "Gris Espacial") (price 29999) (procesador "M1"))
  (computadoras (part-number "lenovo-thinkpad-001") (marca "Lenovo") (modelo "ThinkPad X1") (color "Negro") (price 27999) (procesador "Intel i7"))
  (computadoras (part-number "asus-zenbook-001") (marca "Asus") (modelo "ZenBook 14") (color "Azul") (price 17999) (procesador "AMD Ryzen 5"))
  (computadoras (part-number "acer-swift3-001") (marca "Acer") (modelo "Swift 3") (color "Plateado") (price 14999) (procesador "Intel i5"))
)

(deffacts accesorios
  (accesorios (part-number "charger-001") (nombre "Cargador inalámbrico") (color "Blanco") (price 499))
  (accesorios (part-number "headphones-001") (nombre "Audífonos Bluetooth") (color "Negro") (price 899))
  (accesorios (part-number "screen-protector-001") (nombre "Mica") (color "Negro") (price 150))
  (accesorios (part-number "mouse-001") (nombre "Mouse inalámbrico") (color "Gris") (price 799))
  (accesorios (part-number "laptop-case-001") (nombre "Funda para laptop") (color "Azul") (price 699))
  (accesorios (part-number "monitor-stand-001") (nombre "Soporte para monitor") (color "Negro") (price 999))
  (accesorios (part-number "phone-case-001") (nombre "Funda para celular") (color "Gris") (price 299))
)
